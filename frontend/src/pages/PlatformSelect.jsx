...
const PlatformSelect = () => {
  ...
  const handleSubmit = () => {
    const chosen = platforms.find((p) => p.id === selectedPlatform);
    toast.success(`Selected: ${chosen?.name}`);
    // → replace with navigation or API call
  };
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-[#2563EB]  h-[280px] text-white text-center relative flex items-center justify-center pb-6 px-4">
        {/* Logo Section */}
        <div className="absolute top-5 left-9 w-1/4">
          <Logo />
        </div>
      ...
      <button
        className="bg-[#2563EB] hover:bg-blue-700 active:scale-95 text-white font-semibold
