...
const ShipToForm = ({ order, onSubmit, submitLabel = "Save" }) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  return (
    <form onSubmit={handleSubmit(submitHandler)} className="space-y-4">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div>
          <label className="mb-1 block text-sm text-gray-700">First name <span className="text-red-500">*</span></label>
        ...
        <div>
          <label className="mb-1 block text-sm text-gray-700">Last Name <span className="text-red-500">*</span></label>
          <input {...register("lastName")} className={inputClass} />
        </div>

        <div>
          <label className="mb-1 block text-sm text-gray-700">Company Name <span className="text-red-500">*</span></label>
          <input {...register("companyName")} className={inputClass} />
        </div>

        <div>
          <label className="mb-1 block text-sm text-gray-700">Email <span className="text-red-500">*</span></label>
        ...
        <div>
          <label className="mb-1 block text-sm text-gray-700">Phone <span className="text-red-500">*</span></label>
        ...
        <div>
          ...
          <input {...register("googleSearchAddress")} className={inputClass} />
        ...
        <div>
          <label className="mb-1 block text-sm text-gray-700">Address line 1 <span className="text-red-500">*</span></label>
        ...
        <div>
          <label className="mb-1 block text-sm text-gray-700">Address line 2 <span className="text-red-500">*</span></label>
          <input {...register("addressLine2")} className={inputClass} />
        </div>

        <div>
          <label className="mb-1 block text-sm text-gray-700">Suburb <span className="text-red-500">*</span></label>
        ...
        <div>
          <label className="mb-1 block text-sm text-gray-700">Country/Region <span className="text-red-500">*</span> </label>
